...
更新する場合は、アプリの「ヘルプ」→「更新を確認」を実行してください。新しいバージョンが見つかった場合は、GitHubのリリースページを開いて最新版をダウンロードできます。
...
- **範囲の移動**: 範囲内をドラッグ
- **サイズ変更**: 四隅や辺の中央にあるハンドルをドラッグ。コーナーハンドル（左上・右上・右下・左下）のドラッグ中にShiftキーを押下するとリサイズ前のアスペクト比で固定されます。
...
### ヘルプ
「ヘルプ」メニューから、GitHubのリポジトリを開く、最新版を確認する、アプリのバージョン情報を確認するといった操作ができます。

- **GitHubのリポジトリを開く**: 配布ページやソースコードを確認します。
- **更新を確認**: GitHub Releases 上の最新版を確認し、更新がある場合はリリースページを開きます。
- **ImageCropperについて**: アプリ名、バージョン、実行ディレクトリを表示します。
